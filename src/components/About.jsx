    ...
    return (
        <div id='About' className='h-auto py-10 w-[100%] flex items-center justify-center relative'>
            <div className=" md:w-[80%] w-[90%] flex flex-col lg:flex-row  mx-auto ">
                <div className="lg:w-[40%] w-[100%]  flex pl-8 flex-col items-start justify-center ">
                    ...
                    <Link data-aos-duration="600" data-aos='slide-left' href='#Contact' className='herobtn bgbtn relative text-white px-14 py-3 mt-14 rounded-sm font-semibold  text-center ' >Hire Me </Link>
                </div>
